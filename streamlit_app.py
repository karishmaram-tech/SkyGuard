...
# ══════════════════════════════════════════════════════════════════════════════
# AI INSIGHTS  (Groq — llama-3.1-8b-instant, free tier)
# ══════════════════════════════════════════════════════════════════════════════
...
def generate_route_briefing(facts: RouteFacts,
    ...
    """Call Groq API with the fixed prompt template. Reads key from env."""
    from groq import Groq  # lazy import — only needed when AI page is used

    api_key = os.environ.get("GROQ_API_KEY")
    if not api_key:
        raise EnvironmentError(
            "GROQ_API_KEY is not set. Add it to your environment or "
            "Streamlit secrets."
        )
...
def main():
    ...
    # ══════════════════════════════════════════════════════════════════════════
        ...
        st.caption(
            "Plain-English operational briefings generated by Llama 3.1 (via Groq) "
